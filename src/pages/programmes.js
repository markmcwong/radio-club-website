...
const ProgrammesPage = props => {
    ...
    <Div>
      {arr.map((name, index) => (
        <Div
          ...
          p="0.5rem"
          onClick={() => {
            isCat ? setCurrentProgramme(index + 1) : setYearFilter(name);
            showCatDown(false);
            showDropDown(false);
          }}
        >
  ...
  const {
    data: {
      ...
      allYearJson: { edges: years = [] }
    }
  } = props;
  const yearDropdown = years.map(a => a.node.year);
  console.log(yearDropdown);
  const nav = (year, type, name) => {
    console.log(year, name);
    navigate(
      "/programmes-details/",
      // highlight-start
      {
        state: { dateFilter: year, typeFilter: type, nameFilter: name }
      }
      // highlight-end
    );
  };
  ...
  return (
    <React.Fragment>
      <Div bg="warning100" m={{ t: { xs: "-5vh", lg: "0vh" } }}>
        <Col p={{ b: "10vh", t: { xs: "0vh", lg: "10vh" }, x: { xl: "5vw", lg: "2vw" } }}>
          ...
          <Row p={{ x: { xs: "10vw", lg: 0 }, y: "5vh" }}>
            <Col size={{ xs: "12", lg: "3" }}>
              <Dropdown
                ...
                menu={menuList(
                  ["General Broadcasting", "New Star Hit", "Interviews / Special", "Radio Drama"],
                  true
                )}
              >
                {filter}
            ...
            <Col size={{ xs: "12", lg: "3" }}>
              <Dropdown
                ...
                isOpen={catDown}
                onClick={() => showCatDown(!catDown)}
                menu={menuList(yearDropdown, false)}
              >
                {yearFilter == 0 ? "Any Year" : yearFilter}
              </Dropdown>
            </Col>
          ...
          <Row>
            <motion.div
              onClick={() => setCurrentProgramme(0)}
              style={{
                backgroundColor: "rgb(225, 228, 232)",
                padding: "50px",
                margin: { xs: "-10vw", lg: "0vw" },
                ...
                <Div>
                  ...
                  <Div>
                    ...
                    {programmes.map(jong => {
                      ...
                      if (
                        (type === filter || filter === "Any Programmes") &&
                        (yearFilter == year || yearFilter == "")
                      ) {
                        return (
                          <Row
                            onClick={() => nav(year, type, name)}
                            p={{ y: "1rem" }}
              ...
              >
                {active != 1 && (
                  <Text
                    ...
                    style={{ writingMode: "vertical-rl", textOrientation: "sideways" }}
                  >
                    {smallScreen && <>General Broadcasting</>}
                  </Text>
                )}
                {active == 1 && (
                  <Div>
                  ...
                  <Div>
                    ...
                    <Div>
                      ...
                      {programmes.map(jong => {
                        ...
                        if (type === "New Star Hit" && (yearFilter == year || yearFilter == "")) {
                          return (
                            <Row
                              onClick={() => nav(year, type, name)}
                              p={{ y: "25px" }}
                  ...
                  <Div>
                    ...
                    <Div>
                      ...
                      {programmes.map(jong => {
                        ...
                        if (type === "Radio Drama" && ((yearFilter == date) || (yearFilter == ""))) {
                          //
                          console.log(node);
                          return (
                            <Row
                              onClick={() => nav(parseInt(date), type, name)}
                              p={{ y: "25px" }}
                              style={{ borderBottom: "1px solid" }}
                            >
                              <Col size="4">
