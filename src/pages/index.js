    ...
    return (
      <React.Fragment>
        ...
        <Row h="auto" p={{
          b: "5%",
          t: "5%",
          l: { xs: "7vw", xl: "7.5vw", lg: "5vw" },
          r: { xs: "7vw", xl: "7.5vw", lg: "5vw" }
        }}>
          <Col size={{ xs: "12", lg: "7" }}>
            ...
            <Text textWeight="300" tag="p"
                  textSize={{ xs: "body", sm: "paragraph", md: "subheader", lg: "subheader", xl: "title" }}
                  p={{ t: "2.5vh", r: "10vw" }}>
          ...
          <Col size={{ xs: "12", lg: "5" }} d="flex" align="center">
            <Div bgSize="cover"
                 bgPos="center" w="100%"
                 h={{ xs:"85vw", lg:"80%" }} bgImg={aboutUsImage}/>
          </Col>
        </Row>
                  ...
                  {timetrees.map(timetree => {
                    ...
                    return (
                      ...
                      >
                        ...
                        <Text tag="h1" textWeight="400" textSize="heading"
                              className="vertical-timeline-element-title">{title}</Text>
                        <Text tag="p" textWeight="100" textSize="paragraph">{description}</Text>
                        <br/>
                        <h4 style={{ cursor: "pointer", color: "rgb(255, 159, 7)" }}
                            onClick={() => location.href = link}>{label}</h4>
                      </VerticalTimelineElement>
                    );
                  })}
                </VerticalTimeline>
            ...
            <Col size={{ xs: "12", lg: "5" }} order={{ xs: 1, lg: 2 }}>
              <Div m={{ l: { xl: "-5vw", lg: "-4vw" } }}>
                <Text
                  p={{
                    t: { xs: "2rem", md: "0" },
                    l: { xs: "7vw", xl: "5vw", lg: "3vw" },
                    b: { xs: "1rem", lg: "2rem", xl: "3rem" }
                  }}
                ...
                >
                  ...
                  HKUST. Our orientation activities provide assistance to the freshmen to understand more about the
                  university and integrate into the HKUST community. By participating in our activities like RTHK tour
                  and using the equipment in the radio room to host their own programs, students of HKUST can have a
                  chance to understand the industry of media which they seldom have.
